import{f as c}from"./firebase-cache-CNydOCth.js";import{f as l}from"./firebase-service-DlA8zRSG.js";import"./idb-Dob3nYDb.js";import"./firebase-DLTXyntu.js";class d{constructor(e={}){this.container=e.container||document.body,this.topicoId=e.topicoId||null,this.autoSaveInterval=e.autoSaveInterval||3e4,this.onSave=e.onSave||(()=>{}),this.onChange=e.onChange||(()=>{}),this.content="",this.lastSaved=null,this.autoSaveId=null,this.isDirty=!1,this.templates={sessao:`# Sessão de Estudo
...
`)[0]}...</p>
                ...
                `).join(""):"<p>Nenhuma nota encontrada</p>"};t.removeEventListener("input",this._searchHandler),this._searchHandler=i,t.addEventListener("input",i)}async _searchNotes(e){const t=[];try{const i=(await c.getAllKeys()).filter(o=>o.startsWith("notas_"));for(const o of i)try{const s=await c.get(o);s&&s.content&&s.content.toLowerCase().includes(e)&&t.push({topico:o.replace("notas_",""),preview:s.content.substring(0,100)+"...",content:s.content})}catch(s){console.warn(`Erro ao buscar nota ${o}:`,s)}if(l.isAvailable())try{const o=await l.getCollection("notas");for(const s of o)if(s.content&&s.content.toLowerCase().includes(e)){const n=`notas_${s.topicoId||"global"}`;t.find(r=>r.topico===(s.topicoId||"global"))||t.push({topico:s.topicoId||"global",preview:s.content.substring(0,100)+"...",content:s.content})}}catch(o){console.warn("Erro ao buscar notas no Firestore:",o)}for(let o=0;o<localStorage.length;o++){const s=localStorage.key(o);if(s&&s.startsWith("notas_"))try{const n=JSON.parse(localStorage.getItem(s));n.content&&n.content.toLowerCase().includes(e)&&(t.find(r=>r.topico===s.replace("notas_",""))||t.push({topico:s.replace("notas_",""),preview:n.content.substring(0,100)+"...",content:n.content}))}catch{}}return t}catch(a){return console.error("Erro ao buscar notas:",a),[]}}_closeSearchModal(){const e=this.wrapper.querySelector("#notasSearchModal");e&&(e.style.display="none")}_exportMarkdown(){if(!this.content){alert("Nenhuma nota para exportar");return}const e=new Blob([this.content],{type:"text/markdown"}),t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download=`notas_${this.topicoId||"global"}_${Date.now()}.md`,a.click(),URL.revokeObjectURL(t)}setContent(e){this.content=e,this.editor.value=e,this._updatePreview(),this.isDirty=!0}getContent(){return this.content}async setTopicoId(e){this.isDirty&&await this._save(),this.topicoId=e,await this._loadContent()}destroy(){this.autoSaveId&&clearInterval(this.autoSaveId),this.isDirty&&this._save(),this.wrapper&&this.wrapper.parentNode&&this.wrapper.parentNode.removeChild(this.wrapper)}}typeof module<"u"&&module.exports&&(module.exports=d);export{d as NotasRapidas,d as default};
//# sourceMappingURL=NotasRapidas-DCp2Lx3i.js.map
