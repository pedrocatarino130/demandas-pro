import{s as l,t as v}from"./Toast-CgWkgWJS.js";import{t as k}from"./TaskEditModal-BpBB0i5P.js";import{confirmAction as T}from"./ConfirmModal-BsncAfHd.js";import"./firebase-cache-CPME0ep_.js";import"./idb-Dob3nYDb.js";const u={TODO:{id:"todo",title:"A Fazer",color:"#3b82f6"},DOING:{id:"doing",title:"Fazendo",color:"#f59e0b"},DONE:{id:"done",title:"Feito",color:"#10b981"}},y={Revisão:"doing",Bloqueado:"todo","A Fazer":"todo",Fazendo:"doing",Feito:"done",Concluído:"done"};function S(o){const{container:t,tasks:n=[],onTaskMove:e,onTaskClick:a}=o;t.innerHTML="",t.className="kanban-3columns",t.innerHTML=`
