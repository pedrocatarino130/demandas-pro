...
- `
        ...
        this.wrapper.innerHTML = `
            ...
            <div class="notas-modal" id="notasTemplateModal" style="display:none">
                <div class="notas-modal-content">
                    ...
                    <button class="notas-btn" onclick="this._closeTemplateModal()">Cancelar</button>
                </div>
            </div>
            ...
            <div class="notas-modal" id="notasSearchModal" style="display:none">
                <div class="notas-modal-content">
                    ...
                    <button class="notas-btn" onclick="this._closeSearchModal()">Fechar</button>
                </div>
            </div>
        `;
    ...
    _showTemplateModal() {
        ...
        list.innerHTML = Object.entries(this.templates)
            .map(([name, template]) => `
                <div class="notas-template-item" onclick="this._insertTemplate('${name}')">
