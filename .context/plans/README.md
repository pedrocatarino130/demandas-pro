...
1. [Melhoria de Dados & Sincronia](./melhoria-dados-sincronia.md) — **[EM ANDAMENTO]** Otimizar sincronização Firebase + IndexedDB, melhorar armazenamento, validar modais e requisições
2. [Teamplete](./teamplete.md) — Template de referência para novos planos
