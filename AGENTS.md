...
## Repository map
- `dados.json/` — explain what lives here and when agents should edit it.
- `Doc/` — explain what lives here and when agents should edit it.
- `estudos.html/` — explain what lives here and when agents should edit it.
...
- `playwright.config.js/` — explain what lives here and when agents should edit it.
